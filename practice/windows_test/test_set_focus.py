...
class setf():
    ...
    def set_target_process(self,target_process):
        self.gamename=target_process
        return self
    def setfocus(self):
        pids=self.get_pids_for_pname(self.gamename)
        for pid in pids:
    ...
    def get_pids_for_pname(self,processName):
